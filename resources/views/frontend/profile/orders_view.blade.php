                                            ...
                                            <tr style="background:#E2E2E2;">
                                                ...
                                                <td class="col-md-1">
                                                    ...
                                                    @elseif($order->return_order ==1)
                                                        <label for=""><span class="badge badge-pill badge-info">{{$order->status}}</span> </label>
                                                        <label for=""><span class="badge badge-pill badge-info">Return initiated</span> </label>
                                                    @elseif($order->return_order ==2)
                                                        <label for=""><span class="badge badge-pill badge-info">Return Success</span> </label>
                                                    @endif
                                                </td>
                                                <td class="col-md-3">
